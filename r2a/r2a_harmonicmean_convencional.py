...
class R2A_HarmonicMean(IR2A):
    ...
    def handle_xml_response(self, msg):
        ...
        self.estimateband.append(self.throughputs[-1]) #modo convencional para estimar a banda
    ...
    def handle_segment_size_request(self, msg):
        ...
        valor = harmonic_mean(self.estimateband[-5::]) #média dos últimos 5 números da banda estimada
