...
class R2A_MovingWindowsM5(IR2A):
    ...
    def __init__(self, id):
        ...
        self.w = 0.3 #taxa de variação
        self.k = 0.14 #ganho do sistema
        
        
        self.x_tio = [0] #taxa transferência
        self.x_bar = [0] #largura de banda
        self.y = [0]
        
        self.buffer = [0]
        
        self.lista_qual = [0] #lista com as qualidades pedidas anteriormente
    ...
    def handle_segment_size_request(self, msg):
        ...
        x_tio_media = np.mean(self.x_tio) #média da janela variante
        
        #calculo de y corrigido Equação 9 artigo panda
        self.y.append(self.alfa*(-self.alfa*self.delta_tempo*(x_tio_media - self.x_bar[-1])+x_tio_media))
    
        deltaup = self.e * self.y[-1]
        deltadown = 0
        
        self.buffer = deepcopy(self.whiteboard.get_playback_buffer_size()) #copio o buffer para uma variavel interna
        ...
        segment_estimate = self.lista_qual[-1]
